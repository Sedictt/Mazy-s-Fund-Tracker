      ...
      <div className="flow-root">
        <ul role="list" className="divide-y divide-gray-200">
          {members.map((member) => {
            ...
            return (
              <li key={member.id} className="p-5 flex items-center justify-between space-x-4">
                ...
                {hasPaid ? (
                  <div className="inline-flex items-center px-3 py-1.5 text-sm font-semibold text-green-700 bg-green-100 rounded-full">
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-semibold text-white bg-cyan-500 rounded-lg shadow-sm hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 transition-colors"
                  >
                    Mark as Paid (₱{contributionAmount})
                  </button>
                )}
              </li>
            );
