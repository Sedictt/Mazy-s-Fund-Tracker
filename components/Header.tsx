...
const Header: React.FC<HeaderProps> = ({ page, onSetPage, onLogout, currentUser, onOpenChat, unreadCount = 0, onOpenWishlist, onOpenSettings }) => {
        ...
        <div className="p-4">
          ...
          <nav className="flex flex-col space-y-2">
            ...
            <button
              ...
              className="px-3 py-2 font-medium text-sm rounded-md transition-colors w-full text-left text-gray-500 hover:bg-violet-100 hover:text-gray-700 flex items-center gap-2"
            >
